...
from dtf_waitwatch.config import CollectionConfig, ConfigError, SourceConfig, validate_config
...
def test_config_rejects_intervals_that_do_not_align_with_an_hour(app_config):
    app_config.collection.interval_minutes = 7

    with pytest.raises(ConfigError, match="divide evenly into 60 minutes"):
